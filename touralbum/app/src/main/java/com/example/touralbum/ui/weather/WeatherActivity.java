    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_cityName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MyDialog myDialog = new MyDialog(WeatherActivity.this);
                myDialog.show();
            }
        });
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, jsonObject, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                if(weatherBean.getResult().getHeWeather5().get(0).getStatus().equals("unknown location")){
                    Toast.makeText(WeatherActivity.this, "输入城市有误", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    Toast.makeText(WeatherActivity.this, "更新时间" + weatherBean.getResult().getHeWeather5().get(0).getBasic().getUpdate().getLoc(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(WeatherActivity.this, "网络有误", Toast.LENGTH_SHORT).show();
                refreshLayout.setRefreshing(false);
            }
        });
            ...
            btn_chaxun.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (editText.getText().toString().equals("")) {
                        Toast.makeText(WeatherActivity.this, "输入为空,重新输入", Toast.LENGTH_SHORT).show();
                    } else {
